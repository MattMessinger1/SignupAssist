-- Drop the trigger first, then the function with CASCADE to handle dependencies properly
...
-- Recreate the function with proper security and search path settings
